package com.zhy.stickynavlayout.demo1;
...
public class StickyNavLayout1 extends LinearLayout implements NestedScrollingParent {
    ...
    public StickyNavLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
